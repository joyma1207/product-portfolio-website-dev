                  ...
                  <div className="px-6 py-4 sm:px-8 lg:py-5">
                    <div className="grid w-full grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-6">
                      <section className="min-w-0 text-left">
                        ...
                        <p
                          className={`text-base text-gray-600 leading-relaxed ${project.id !== "caisa-fashion" ? "mt-2" : ""}`}
                        >
                          {project.problem}
                        </p>
                      </section>
                      <section className="min-w-0 text-left">
                        ...
                        <ul className="mt-2 space-y-2 text-base text-gray-600 leading-relaxed list-disc list-inside">
                          {bulletsFromParagraphs(project.whatOwned).map((line, i) => (
                            <li key={i}>{line}</li>
                          ))}
                        </ul>
                      </section>
                      <section className="min-w-0 text-left">
                        ...
                        <ul className="mt-2 space-y-2 text-base text-gray-600 leading-relaxed list-disc list-inside">
                          {bulletsFromLines(project.impact).map((line, i) => (
                            <li key={i}>{line}</li>
                          ))}
                        </ul>
                      </section>
